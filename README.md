...
El **GIC (Gestor Inteligente de Clientes)** es una plataforma integral desarrollada en Python que permite gestionar tres tipos de clientes (`Regular`, `Premium` y `Corporativo`), aplicando los principios de la **Programación Orientada a Objetos**: encapsulación, herencia y polimorfismo.
...
class ClientePremium(Cliente):
    def __init__(self, ..., nivel_premium=1):
...
*Proyecto desarrollado para el Módulo #4 — Python · POO · Bases de Datos · APIs*
# Modulo4_GIC_pythom
